...
def scrape_movie_details(movieUrl):
    ...
    recView = soup.find('div', {'class':'rec_view'})
    recPage = recView.find('div', {'class':'rec_page'})
    recPageRecSelected = recView.find('div', {'class':'rec_page rec_selected'})
    recItemPageOne = recPage.findAll('div', {'class':'rec_item'})
    recItemPageTwo = recPage.findAll('div', {'class':'rec_item'})
    pprint (recItemPageTwo)
